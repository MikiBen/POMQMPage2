...
public class ImpressumFooter {
    @Test
    public static void checkImpessumInFooter(WebDriver driver, WebElement webElement) {

        try {
            Assert.assertEquals(Base.adressPage + "/de/impressum/", driver.getCurrentUrl());
            ...
            System.out.println("On page: " + driver.getCurrentUrl() + " I can not find ImpressumDE button in Footer");
            Assert.fail();
