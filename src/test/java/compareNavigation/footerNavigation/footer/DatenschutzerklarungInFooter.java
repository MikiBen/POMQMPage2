...
public class DatenschutzerklarungInFooter {

    @Test
    public static void checkNavigateLink(WebDriver driver, WebElement webElement) {

        try {
            Assert.assertEquals(Base.adressPage + "/de/datenschutzerklarung/", driver.getCurrentUrl());
            ...
            System.out.println("On page: " + driver.getCurrentUrl() + " I can not find DatenschutzerklarungDE button in Footer");
            Assert.fail();
